...
<body>
    ...
    <div class="signup">
        ...
        <form action="Donor_Reg.php" method="post">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="number" name="Dnumber" class="form-control" id="inputEmail3">
              </div>
            </div>
            <div class="row mb-3">
              <label for="inputEmail3"  class="col-sm-2 col-form-label">Date of Birth</label>
              <div class="col-sm-10">
                <input type="date" name="Ddob" class="form-control" id="inputEmail3">
              </div>
            </div>
    ...
    <div class="redirect">
        Already have a Donor-ID?
        <a href="Donates.php">Click Here</a>
    </div>
</body>
</html>